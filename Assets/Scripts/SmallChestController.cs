...
public class SmallChestController : ChestController
{
    [SerializeField] private int defaultHealth;
    [SerializeField] private Transform dropPoint;
    [SerializeField] private float dropPower;
    [SerializeField] private ItemInfo beer;
    [SerializeField] private ItemInfo wine;
    [SerializeField] private float wineDropProbability;
    ...
    public override void Hit()
    {
        ...
        {
            Drop(Random.Range(0f, 1f) <= wineDropProbability ? wine : beer);
